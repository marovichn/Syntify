...
function useSound(src, _ref) {
  ...
  var _ref2 = _ref,
    ...
    onload = _ref2.onload,
    delegated = _objectWithoutPropertiesLoose(_ref2, [
      "id",
      "volume",
      "playbackRate",
      "soundEnabled",
  ...
  useOnMount(function () {
    import("howler").then(function (mod) {
      if (!isMounted.current) {
        ...
        HowlConstructor.current =
          (_mod$Howl = mod.Howl) !== null && _mod$Howl !== void 0
            ? _mod$Howl
            : mod["default"].Howl;
  ...
  var play = React__default.useCallback(
    function (options) {
  ...
  var stop = React__default.useCallback(
    function (id) {
      if (!sound) {
        return;
      }
  ...
  var pause = React__default.useCallback(
    function (id) {
      if (!sound) {
        return;
      }
